...
private val terms = listOf(
    ...
    TermItem(
        "التحديثات والأمان",
        "تُوزَّع تحديثات التطبيق الرسمية عبر Google Play. لا يطلب التطبيق تثبيت حزم APK من مصادر خارجية، وأي رابط تحديث أو إصدار غير منشور عبر القنوات الرسمية لا يُعد إصداراً موثوقاً من المشروع."
    ),
    TermItem(
        "التعديلات",

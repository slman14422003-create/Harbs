...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        // ═══ طلب المستخدم: منع لقطة الشاشة والتسجيل في كامل التطبيق ═══
        ...
        // أسود لحظياً عند كل "تبديل ثم عودة". هذا التنقّل الجزئي حسب الشاشة
        // أُزيل الآن بطلب صريح من المستخدم بتعميم المنع على التطبيق كاملاً
        // (لا فقط شاشات الإدارة)، فالعلَم يُضبط هنا مرة واحدة طوال حياة
        // النشاط ولم يعد يُزال أو يُعاد ضبطه من HerbalNavGraph حسب المسار.
        // الأثر الجانبي أعلاه (فقدان الصورة المصغّرة في Recents) يبقى قائماً
        // الآن على كل شاشات التطبيق، لا شاشات الإدارة فقط — وهذا مقصود.
